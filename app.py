...
options_types_collision = ['Vehicle with vehicle collision',
...
# features list
features = ['Number_of_vehicles_involved',
...
#---------------------------------------------------------------------------------
# User Input & Model Prediction Section
...
# predict the target from all the input features
       ...
       st.markdown("""Reach out to him on: [Twitter](https://twitter.com/avikumart_) |
       [Linkedin](https://www.linkedin.com/in/avi-kumar-talaviya-739153147/) |
       [Kaggle](https://www.kaggle.com/avikumart)
       """)
       st.markdown("Learn and practiced by: **[Shruti Agarwal](https://github.com/ShruAgarwal)**")
#---------------------------------------------------------------------------------
# Webpage's Aesthetics Section
